...
def check_mobile(agent):
    ...
    :传入数据: request.header['User-Agent']

    :返回数据: true（手机端） 或 false（PC端）

    """

    _long_matches = (r'googlebot-mobile|android|avantgo|blackberry|blazer|\
        elaine|hiptop|ip(hone|od)|kindle|midp|mmp|mobile|o2|opera mini|\
        palm( os)?|pda|plucker|pocket|psp|smartphone|symbian|treo|\
        up\.(browser|link)|vodafone|wap|windows ce; (iemobile|ppc)|\
        xiino|maemo|fennec')
    _long_matches = re.compile(_long_matches, re.IGNORECASE)
    _short_matches = (r'1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|\
        ...
        le(no|xi)|lg( g|\/(k|l|u)|50|54|e\-|e\/|\-[a-w])|libw|lynx|m1\-w|\
        m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(di|rc|ri)|\
        ...
        owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|\
        ...
        sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|\
    ...
    if _long_matches.search(agent) is not None:
        return True
    user_agent = agent[0:4]
